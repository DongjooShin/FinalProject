			...
			<div class="col-md-9" style="margin-top: 50px;">
				...
				<div class="container mainpage1" id="main"
					...
					<form role="form" id="main_input_box">
						...
						<input type="text" class="form-control" id="custom_textbox"
							name="Item" placeholder="설문지 질문을 적으세요!"
							style="height: 100px; width: 70%;"> <input type="hidden"
							name="count" value="count"> <input type="submit"
							value="Add" class="btn btn-primary add_button"
					...
					<form action="/Survey/surveyRegist" method="post">
						...
						<div>
							시작일 <select class="form-control2" name="st1" id="select">
								...
								%>
							</select>월 <select class="form-control2" name="st2" id="select">
								<%
									for (int i = 1; i < 32; i++) {
								%>
								...
								%>
							</select>일 종료일 <select class="form-control2" name="end1" id="select">
								...
								%>
							</select>월 <select class="form-control2" name="end2" id="select">
								<%
									for (int i = 1; i < 32; i++) {
								%>
						...
						<div>
							<br> <input type="submit" value="설문지 작성완료"
								style="width: 20%; height: 45px;">
						</div>
