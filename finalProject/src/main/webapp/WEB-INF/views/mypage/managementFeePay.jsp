...
<script type="text/javascript" src="/resources/js/kyungtae/bootstrap.min.js"></script>
<style type="text/css">
#Table_01{
...
<div class="row">
	<div class="col-lg-12">
		<table id="Table_01" width="659" height="622" border="0" cellpadding="0" cellspacing="0">
		   <tr>
		      <td colspan="19">
		         <img src="/resources/images/kyungtae/blank.png" width="657" height="8" alt=""></td>
		      <td>
	...
	<div id="buttonArea">
		<input type="button" id="mntPay" value="결제하기"/>&nbsp;<input type="button" id="mntPay" value="닫기"/>
	</div>
