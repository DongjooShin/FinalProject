...
<form action="delectMsg" method="post">
		...
		<input type="hidden" name="readPage" value="2">
	</tr>
					...
					<div class="text-center">
						<ul class="pagination">
							...
							<c:if test="${pageMaker.prev}">
								<li><a
									href="/mypage/sendMessageList${pageMaker.makeSearch(pageMaker.startPage - 1) }">&laquo;</a></li>
							</c:if>
							...
							<c:forEach begin="${pageMaker.startPage }"
								...
								<li
									...
									<a href="/mypage/sendMessageList${pageMaker.makeSearch(idx)}" id="massage"+${idx }">${idx}</a>
							...
							<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
								<li><a
									href="/mypage/sendMessageList${pageMaker.makeSearch(pageMaker.endPage +1) }">&raquo;</a></li>
							</c:if>
