		...
		<div class="col-lg-10" style="background-color: white;">
					...
					<div class="box box-primary">
						...
						<form role="form" action="modifyPage" method="post">
							...
							<input type='hidden' name='cp_complaintNo'
								value="${complaint.cp_complaintNo}"> <input
						...
						<div class="box-body">
							<div class="form-group">
								...
								<label for="exampleInputEmail1">Title</label> <input type="text"
									name='cp_title' class="form-control"
									value="${complaint.cp_title}" readonly="readonly">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label for="exampleInputEmail1">Writer</label> <input
									type="text" name="m_memberNo" class="form-control"
									value="${complaint.m_memberNo}" readonly="readonly" height="20">
							</div>
						</div>
						<!-- /.box-body -->
			...
			<div class="row">
				<div class="col-md-12">
					...
					<input type="hidden" value="${member.m_memberNo }"
						id="newReplyWriter">
					<div class="box box-success">
						...
						<div class="box-body">
							<label for="exampleInputEmail1"></label> <label
								for="exampleInputEmail1">내용 </label> <input class="form-control"
...
<script>
	$(document).ready(function() {
		...
		$("#modifyBtn").on("click", function() {
			formObj.attr("action", "/publicmana/modifyPage");
			formObj.attr("method", "post");
			formObj.submit();
		});

		$("#removeBtn").on("click", function() {
			formObj.attr("action", "/publicmana/removePage");
			formObj.submit();
		});
