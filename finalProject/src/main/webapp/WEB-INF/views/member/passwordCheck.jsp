...
<body>
	...
	<div id="passwordCheckDiv" class="col-lg-12">
		...
		<input type="hidden" id="passwordCh" value="${password }">
		...
		<div class="col-lg-6  col-lg-offset-3" style="margin-top: 50px; border: 4px solid #eaeaea; border-radius: 5px; padding: 40px 0 0 25px;">
			<div class="col-lg-12">
				<div style="" class="insert-form">
					<div class="col-lg-4">
						<label style="font-size: 20px; padding-top: 10px;">아이디 :</label>
					</div>
					<div class="col-lg-7">
			...
			<div class="col-lg-12">
				<div style="" class="insert-form">
					...
					<div class="col-lg-7 ">
						<input type="password" value="" style="padding: 0; height: 40px;"
