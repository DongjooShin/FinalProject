						...
						<div class="well bs-component">
							<form class="form-horizontal" action="/Property/aptSale?pr_propertyNo=0" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-lg-7">
											<%-- <input type="text" class="form-control" name="pr_addr" value="${property.pr_addr}"> --%>
															<input type="text" id="sample3_postcode" placeholder="우편번호">
										- <input type="button" onclick="sample3_execDaumPostcode()" name="pr_addr"
											value="우편번호 찾기"><br>
									...
									<div class="form-group">
										...
										<div class="col-lg-7">
											<input type="file" class="form-control1" name="pr_imageName" placeholder="파일">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-3">
											<input type="text" class="form-control" name="pr_price" value="${property.pr_price}">
										</div>

										<label class="col-lg-1 control-label">보증금</label>
										<div class="col-lg-3">
											<input type="text" class="form-control" name="pr_deposit" value="${property.pr_deposit}">
										</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-3">
											<input type="text" class="form-control" name="pr_level" value="${property.pr_level}">
										</div>

										<label class="col-lg-1 control-label">총층수</label>
										<div class="col-lg-3">
											<input type="text" class="form-control" name="pr_totalLevel" value="${property.pr_totalLevel}">
										</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-3">
											<input type="text" class="form-control" name="pr_roomNum" value="${property.pr_roomNum}">
										</div>

										<label class="col-lg-1 control-label">욕실수</label>
										<div class="col-lg-3">
											<input type="text" class="form-control" name="pr_bathNum" value="${property.pr_bathNum}">
										</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-3">
											<input type="text" class="form-control" name="pr_scale" value="${property.pr_scale}">
										</div>

										<label class="col-lg-1 control-label">건설회사</label>
										<div class="col-lg-3">
											<input type="text" class="form-control" name="pr_company" value="${property.pr_company}">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-7">
											...
											<span class="help-block"> ${property.pr_content}</span>
										</div>
									</div>
