									...
									<c:forEach var="property" items="${list }">
										<tr height="30">
											...
											<td align="center"><c:if
													test="${property.pr_imageName != null}">
											...
											<td align="left"><a
												href="/Property/aptSaledetail?pr_propertyNo=${property.pr_propertyNo }">${property.pr_APTName }</a></td>
											<td align="center">${property.pr_APTName }</td>
											<td align="center"><fmt:formatDate
													value="${property.pr_date }" pattern="yyyy-MM-dd" /></td>
										</tr>
							...
							<div class="checkbox123">
								<form action="aptSaleList.jsp" method="post">
									...
									<input type="text" name="searchKey" size="10"
										style="width: 30%"> <input type="hidden" name="temp"
										value="temp"> <input type="submit" value="검색">
									<!-- 이거 pr이어야 검색되겟다 -->
