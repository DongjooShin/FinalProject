	...
	<div id="page" class="main">
		<div class="col-md-12">
			<div class="row">
				...
				<div class="col-lg-9">
				<br><br>
<label style="font-size: 25px; color: black; border-bottom: 3px solid #eaeaea; padding: 0 15px 13px 15px; margin-bottom: 15px;">공동구매목록</label>
		<br><br>
					<div class="row">
						<!-- left column -->
						<div class="col-md-11">
									...
									<table class="table table-bordered">
										...
										<c:forEach items="${list}" var="list">
											...
											<tr>
												...
												<td><a
													href="javascript:detailaddress(${list.check_no})">배송지보기</a></td>
												<td>${list.check_sign  }</td>
												<td><input type="checkbox" name="cpupdate"
													value="${list.check_no}"></td>
