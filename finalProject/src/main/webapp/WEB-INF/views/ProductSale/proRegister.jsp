	...
	<div id="page" style="background: white; display: inline-block;">
		<div class="col-md-12">
			...
			<div class="col-lg-10 col-lg-offset-1">
				...
				<form action="" id="ajaxform" name="ajaxform" method="post"
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<input type="text" class="form-control" name="m_memberNo"
								value="${product.m_memberNo}" disabled="disabled">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							...
							${product.pro_group} <input type="hidden" name="pro_group"
								value="${product.pro_group}">
					...
					<div class="form-group">
						...
						<div class="col-lg-6 col-lg-offset-2" style="margin-bottom: 30px;">
							<div class="fileDrop1">
								...
								<input type="file" id="pro_img1" name="pro_img1"
									style="width: 100%">
					...
					<div class="form-group">
						...
						<div class="col-lg-5"
							style="margin-left: 38%; margin-bottom: 30px;">
							<div class="fileDrop">
					...
					<div class="form-group">
						...
						<div class="col-lg-7">
							...
							<label class="font">시작일</label> <select class="form-control"
								name="pro_sdate1" id="select" style="width: 90px; float: left;">


								<div>
									<option>2016</option>
							</select> <label class="font">년</label> <select class="form-control"
								name="pro_sdate2" id="select" style="width: 70px; float: left;">
								...
								<option>11</option>
								<option>12</option>
							</select> <label class="font">월</label> <select class="form-control"
								name="pro_sdate3" id="select" style="width: 70px; float: left;">
								<c:forEach begin="1" end="9" var="list">
									<option>0${list}</option>
								</c:forEach>
							...
							</select> <label class="font">일</label> <br>
							<br> <label class="font">종료일</label> <select
								class="form-control" name="pro_edate1" id="select"
								style="width: 90px; float: left;">
								<option>2016</option>

							</select> <label class="font">년</label> <select class="form-control"
								name="pro_edate2" id="select" style="width: 70px; float: left;">
								<c:forEach begin="1" end="9" var="list">
									<option>0${list}</option>
								</c:forEach>
								<option>10</option>
								...
								name="pro_edate3" id="select" style="width: 70px; float: left;">
				...
				<div class="col-lg-7">
					...
					<p>
						<input type="radio" name="1" value="1"
							onchange="Postcost(this.value)" checked="checked">배송비무료&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="1" value="2"
							onchange="Postcost2(this.value)">배송비유료
					</p>
			...
			<div class="form-group">
				...
				<div class="col-lg-7">
					<textarea class="form-control" rows="3" name="pro_context"
			...
			<div class="form-group">
				...
				<div class="col-lg-7">
					...
					<input type="submit" value="등록하기" onclick="avx12()">
					</form>
