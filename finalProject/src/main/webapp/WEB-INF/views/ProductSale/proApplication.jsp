...
<link href="../../../resources/bootstrap/bootstrap.min.css"
	rel="stylesheet">
</head>
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="col-md-9" style="margin-top: 17px;">
					<div class="row">
					<br><br>
<label style="font-size: 25px; color: black; border-bottom: 3px solid #eaeaea; padding: 0 15px 13px 15px; margin-bottom: 15px;">구매자공동구매신청</label>
		<br><br>
						<div class="col-lg-12">
							...
							<div class="well bs-component">
								<form class="form-horizontal"
									action="/ProductSale/proApplication" method="post">
