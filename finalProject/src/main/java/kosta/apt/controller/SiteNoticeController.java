...
//------------- Site Inquiry -------------------	
	...
	public String inquiryRead(@RequestParam("qnaNo")int qnaNo,@ModelAttribute("cri")SNSearchCriteria cri,Model model)throws Exception{	
...
/*
	@RequestMapping(value="inqReply",method=RequestMethod.POST)
	public String inqReplyPOST(QnA sn,RedirectAttributes rttr)throws Exception{
		System.out.println("sn modify post controller 들어옴");
		System.out.println("객체내용"+sn.toString());
		
	//	snService.inqReply(sn);
		rttr.addFlashAttribute("msg", "SUCCESS");
